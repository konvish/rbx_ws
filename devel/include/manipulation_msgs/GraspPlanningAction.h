...
bool operator==(const ::manipulation_msgs::GraspPlanningAction_<ContainerAllocator1> & lhs, const ::manipulation_msgs::GraspPlanningAction_<ContainerAllocator2> & rhs)
{
