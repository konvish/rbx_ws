...
namespace rbx2_utils
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(Pub3DTargetConfig &config, const Pub3DTargetConfig &max, const Pub3DTargetConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const Pub3DTargetConfig &config1, const Pub3DTargetConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, Pub3DTargetConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const Pub3DTargetConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, Pub3DTargetConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const Pub3DTargetConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const Pub3DTargetConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, Pub3DTargetConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
